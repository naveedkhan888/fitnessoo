<?php
	$page_title    = get_theme_mod( '404_title', esc_html__( 'Page not Found', 'themename' ) );
	$page_subtitle = get_theme_mod( '404_message', esc_html__( 'It looks like nothing found here. Try to navigate the menu or return to the home page.', 'themename' ) );
	$page_big      = get_theme_mod( '404_big', esc_html__( '404', 'themename' ) );
	$page_button   = get_theme_mod( '404_button', esc_html__( 'Back to homepage', 'themename' ) );
?>
