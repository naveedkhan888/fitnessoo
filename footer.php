...
$page_footer_settings       = xpoint_get_document_option( 'page_footer_settings' );
$footer_hide                = false;
$class_container            = get_theme_mod( 'footer_container', 'container-fluid' );
$class_row                  = 'align-items-center';
$class_col                  = '';
$col_copyright              = 'col-lg-6';
$footer_has_active_sidebars = xpoint_footer_has_active_sidebars();
...
if ( $page_footer_settings ) {
	...
	if ( xpoint_get_document_option( 'page_footer_hide' ) ) {
		$footer_hide = true;
	}
}
