 ...
 */
add_action( 'elementor/theme/register_locations', 'xpoint_register_elementor_locations' );
function xpoint_register_elementor_locations( $elementor_theme_manager ) {
 ...
 */
add_action( 'elementor_pro/init', 'xpoint_enqueue_elementor_pro_widgets_assets' );
function xpoint_enqueue_elementor_pro_widgets_assets() {
 ...
 */
add_action( 'init', 'xpoint_remove_elementor_welcome_screen' );
function xpoint_remove_elementor_welcome_screen() {
