 ...
 * for Elementor
 */
if ( ! function_exists( 'xpoint_get_document_option' ) ) {
	function xpoint_get_document_option( $option, $post_id = null, $option_default = false ) {
		if ( did_action( 'elementor/loaded' ) && function_exists( 'xpoint_elementor_get_document_option' ) ) {
			return xpoint_elementor_get_document_option( $option, $post_id, $option_default );
		}
	}
}
 ...
 * @return bool
 */
function xpoint_is_built_with_elementor( $post_id = null ) {
 ...
 * @return bool
 */
function xpoint_is_elementor_editor_active() {
 ...
 * @return bool
 */
function xpoint_is_elementor_feature_active( $feature_name ) {
