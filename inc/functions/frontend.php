...
function arts_enqueue_styles() {
	...
	wp_enqueue_style( 'themename-main-style', ARTS_THEME_URL . '/css/main.css', array(), ARTS_THEME_VERSION );
	wp_enqueue_style( 'themename-theme-style', ARTS_THEME_URL . '/style.css', array(), ARTS_THEME_VERSION );
...
function arts_enqueue_scripts() {
	...
	wp_enqueue_script( 'themename-components', ARTS_THEME_URL . '/js/components.js', $main_script_deps, ARTS_THEME_VERSION, true );

	/**
	 * Enqueue Elementor Frontend Editor Script
	 */
	if ( arts_is_elementor_editor_active() ) {
		wp_enqueue_script( 'themename-elementor-preview', ARTS_THEME_URL . '/js/elementor-preview.min.js', array( 'elementor-frontend', 'elementor-inline-editor' ), ARTS_THEME_VERSION, true );
	}
}
...
function arts_customize_preview_script() {
	wp_enqueue_script( 'themename-customizer-preview', ARTS_THEME_URL . '/js/customizer.min.js', array(), ARTS_THEME_VERSION, true );
}
