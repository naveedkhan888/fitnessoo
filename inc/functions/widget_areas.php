...
function arts_register_widget_areas() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Blog Sidebar', 'themename' ),
			'id'            => 'blog-sidebar',
			'description'   => esc_html__( 'Appears in blog.', 'themename' ),
	...
	for ( $i = 1; $i <= $footer_columns; $i++ ) {
		register_sidebar(
			array(
				'name'          => sprintf( esc_html__( 'Footer %s Column', 'themename' ), $i ),
				'id'            => 'footer-sidebar-' . $i,
				'description'   => esc_html__( 'Appears in Page Footer.', 'themename' ),
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer Bottom Row', 'themename' ),
	...
	if ( class_exists( 'SitePress' ) || class_exists( 'Polylang' ) || class_exists( 'TRP_Translate_Press' ) ) {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Language Switcher Area', 'themename' ),
				'id'            => 'lang-switcher-sidebar',
				'description'   => esc_html__( 'Appears in the top menu.', 'themename' ),
				'before_widget' => '<section id="%1$s" class="widget %2$s">',
				'after_widget'  => '</section>',
			)
		);
