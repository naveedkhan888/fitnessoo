...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	<p><?php echo sprintf( '%1$s <a href="%2$s">%3$s</a>', esc_html__( 'Ready to publish your first post?', 'themename' ), esc_url( admin_url( 'post-new.php' ) ), esc_html__( 'Get started here!', 'themename' ) ); ?>
